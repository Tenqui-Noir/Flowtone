...
Flowtone 是一个 Android 本地音乐播放器。当前阶段是 Flowtone 0.4：在 0.3 UI internal 的基础上，整理播放架构边界，并为后续接入 MediaSession、通知栏媒体控件和后台播放做准备。
...
- 尚未接入 MediaSession、MediaSessionService、通知栏媒体控件或后台播放。
